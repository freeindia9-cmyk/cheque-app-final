...
# ==========================================
# 9. HTML Template with 4-Second Splash Screen
# ==========================================
...
<head>
    ...
    <style>
        ...
        .splash-overlay {{
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at center, #064e3b, #022c22, #011410);
            z-index: 99999;
            display: flex;
        ...
        .splash-title {{
            ...
            text-transform: uppercase;
            text-shadow: 0 0 20px rgba(52, 211, 153, 0.9);
            margin: 0;
        }}
  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 620px; background-color: #064e3b; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.4);">
    <tr>
      <td style="padding: 24px; text-align: center;">
        ...
        <div style="margin-top: 12px; font-weight: bold; color: #a7f3d0; font-size: 13px;">
          ✨ {cfa_title}
        </div>
      </td>
    </tr>
...
# ==========================================
# 10. Live Simulator Display Panel
# ==========================================
...
# ==========================================
# 11. Main Automated Dispatch Execution
# ==========================================
if start_btn:
    st.session_state['stop_dispatch'] = False
    st.session_state['sent_count'] = 0
