        ...
        try:
            ...
            for idx in range(len(df)):
                ...
                if "@" in target_email:
                    ...
                    msg['To'] = target_email
                    msg['Subject'] = f"💳 Cheque Details Statement - {party_name} ({rec_date})"
                    ...
                    <body>
                      <div class="email-container">
                        <div class="company-intro-banner">
                          <h1 class="company-name-text">CHEQUE STATEMENT DETAILS</h1>
                    ...
                    try:
                        ...
                        status_box.markdown(f"✅ Cheque Details Sent: **{party_name}** (`{target_email}`) | Bank: `{bank_val}` | Used: `{used_cheques}`")
            ...
            if not st.session_state['stop_dispatch']:
                st.balloons()
                st.success("🎉 All cheque details emails dispatched successfully!")
